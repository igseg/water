...
prediction = model_2_rever(results_correlated_residuals_2.parmEsts, times[1:])
residuals = ts.price_power.values[2:] - prediction
...
np.savetxt('Models/coeficients/residuals/price_e_residuals.csv', residuals, delimiter=',')
